...
function Assignments() {
    ...
    return ( <
        ...
        <
        i className = "black-color" > < FontAwesomeIcon icon = { faGripVertical }
        /></i >
        <
        ...
        div > {
            courseAssignments.map((assignment) => ( <
                ...
                className = "lbs" >
                <
                i className = "fas fa-grip-vertical black-color" > < FontAwesomeIcon icon = { faGripVertical }
                /></i >
                <
                /button> <
                button type = "button"
                className = "lbs" >
                <
                i className = "far fa-clipboard colorpad" > < FontAwesomeIcon icon = { faClipboard }
                /></i >
                <
                /button> <
                /div> <
                ...
                className = "set-font-style" > { assignment._id } - { assignment.title } <
                /Link> <
                /div> <
                ...
                disabled >
                <
                i className = "fas fa-check-circle correct-symbol" > < FontAwesomeIcon icon = { faCheckCircle }
                /></i >
                <
                /button> <
                button type = "button"
                className = "button-setup" >
                <
                i className = "fas fa-ellipsis-v" > < FontAwesomeIcon icon = { faEllipsisV }
                /></i >
                <
                /button> <
                /div> <
