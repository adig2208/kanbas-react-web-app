    ...
    <div className="col-md-9 right-content">
                            <div className="row">
                                <div className="col-12">
                                    <button type="button" className="btn btn-light float-right">
                                        <i className="black-color"><FontAwesomeIcon icon ={faEllipsisV}/></i>
                                    </button>
                                    <button type="button" className="published-button-setup float-right button-margin">
                                        <i className="button-color"><FontAwesomeIcon icon={faCheckCircle}/></i>
                            ...
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <input id="assignment-name" type="text" value="A1 - ENV + HTML" className="form-control"/>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-12">
                                    <textarea cols="155" rows="5" className="form-control content-margin">TAssignment Description
                                    </textarea>
                                </div>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                ...
                                <div className="col-7 content-margin">
                                    <input type="checkbox" value="Text Entry" name="check-entry-option" id="chkbox-entry" />
                                ...
                                <table width="94%" className="set-table content-margin">
                                    <tr>
                                        <td className="td-2" valign="top">
                                            <label for="assign" className="content-margin float-right set-table-label">Submission Type</label>
                                        </td>
                                        <td className="set-table table-border padding-left">
                                        <select id="Submission-Type" className="form-control set-text-input">
                            ...
                            <div className="row" id="assign-table">
                                <table width="94%" className="set-table content-margin">
                                    <tr>
                                        <td className="td-2" valign="top">
                                            <label for="assign" className="content-margin float-right set-table-label">Assign</label>
                                        </td>
                                        <td className="set-table table-border padding-left">
                                            <label for="assign-to"><b>Assign to</b></label><br/>
                                            <input className="form-control set-table-width" type="text" id="assign-to" value="Everyone" /><br/>


                                            <label id="due-id" className="control-label"><b>Due</b></label><br/>
                                            <input id="due-id" type="date" value="2021-01-01" className="form-control set-table-width"/><br/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table width="100%" className="table-background">
                                                <tr>
                                                    <td>
                                                        <button width="80%" type="button" className="form-control add-button">+Add</button>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <div className="row" style = {{marginTop:25,marginBottom:20}}>
                                <div className="col-12">
                                    <button type="button" onClick={handleSave} className="btn btn-light float-right">Cancel</button>
                                    <button type="button" onClick={handleSave} className="btn btn-danger float-right">Save</button>
                                </div>
                            </div>
                        </div>
