...
function WorkingWithObjects() {
  ...
  const URL = `${API_LAB_BASE}/a5/assignment`;
  ...
  return (
    <div>
      <h3> Working With Objects </h3> <h4> Retrieving Objects </h4>
      <a
        href={`${API_LAB_BASE}/a5/assignment`}
      ...
      <a
        href={`${API_LAB_BASE}/a5/assignment/title`}
        className="btn btn-primary me-2"
      >
        Get Title
      </a>
      ...
      <button onClick={fetchAssignment} className=" btn btn-danger mb-2 w-100">
        Fetch Assignment
      </button>
      <a
